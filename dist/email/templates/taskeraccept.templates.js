...
exports.taskerAcceptTask = void 0;
const taskerAcceptTask = (task, tasker, viewTaskDetailsUrl) => `
<!DOCTYPE html>
<html>
...
style = "background-color: #28a745; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block; margin-right: 10px;" >
    Xem Chi Tiết Công Việc
        ...
        < !--Footer -->
            ...
            `;
exports.taskerAcceptTask = taskerAcceptTask;
//# sourceMappingURL=taskeraccept.templates.js.map